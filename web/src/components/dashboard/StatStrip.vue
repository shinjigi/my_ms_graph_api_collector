<template>
    <div class="grid grid-cols-6 gap-2 mb-4">
        ...
        <!-- Commit -->
        <BaseCard class="cursor-pointer hover:border-secondary/50 transition-colors" @click="navigate('activity')">
            ...
            <div class="text-xs text-base-content/40 mt-0.5 flex gap-2">
                <SignalBadge type="git" :count="gitCount" label="Git" />
                <span>·</span>
                <SignalBadge type="svn" :count="svnCount" label="SVN" />
            </div>
        </BaseCard>
        <!-- Meeting -->
        <BaseCard class="cursor-pointer hover:border-accent/50 transition-colors" @click="navigate('teams')">
