...
export const TS_ACTIVE: TsRow[] = [
    { project:'BAU - Your Team Name', us:'Staff company meetings #2026',      tpId:326100, state:'Inception',     totAllTime:47,  hours:[0,0,0.5,0,0,0,0],   git:[0,0,1,0,0,0,0], svn:[0,0,0,0,0,0,0], notes:[null,null,'Standup BAU ITA',null,null,null,null] },
    { project:'BAU - Your Team Name', us:'Deploy process #2026',              tpId:326279, state:'Inception',     totAllTime:112, hours:[0,0,0,0,1,0,0],     git:[0,0,0,1,1,0,0], svn:[0,0,0,0,0,0,0], notes:[null,null,null,null,'Pipeline ACC fix',null,null] },
    { project:'BAU - Your Team Name', us:'AssetVersioning updates',           tpId:326215, state:'Dev/Unit test', totAllTime:89,  hours:[1,0,1,0,0.5,0,0],   git:[1,0,1,0,0,0,0], svn:[0,0,0,0,0,0,0], notes:['auth config',null,'asset migr.',null,'batch fix',null,null] },
    { project:'BAU - Your Team Name', us:'PC emails network TP #2026',        tpId:324913, state:'Inception',     totAllTime:203, hours:[1,0,2.5,1,1,0,0],   git:[0,0,0,0,0,0,0], svn:[0,0,1,0,0,0,0], notes:['graph auth',null,'filter API + paginaz.',null,'send module',null,null] },
    { project:'BAU - Your Team Name', us:'SnapTest #2026',                    tpId:326301, state:'Inception',     totAllTime:31,  hours:[0,0,0,1,0.5,0,0],   git:[0,0,0,0,0,0,0], svn:[0,0,0,0,0,0,0], notes:[null,null,null,'analisi scenari',null,null,null] },
    { project:'BAU - Your Team Name', us:'Incident #2026',                    tpId:326200, state:'Inception',     totAllTime:18,  hours:[0.5,0,0,0.5,0,0,0], git:[0,0,0,0,0,0,0], svn:[0,0,0,0,0,0,0], notes:['hotfix prod',null,null,'triage',null,null,null] },
...
export const TS_PINNED: TsRow[] = [
    { project:'BAU - Your Team Name',  us:'English Course - AltreAule 2025',          tpId:325800, state:'Dev/Unit test', totAllTime:24 },
    { project:'BAU - Your Team Name',  us:'Business support / Other teams #2026',     tpId:326110, state:'Inception',     totAllTime:67 },
    { project:'BAU - Your Team Name',  us:'Sitecore Refactors and Updates #2026',     tpId:326155, state:'Inception',     totAllTime:8,  rem:0.2 },
    { project:'BAU - Your Team Name',  us:'Sprint ceremonies & planning #2026',       tpId:326080, state:'Inception',     totAllTime:32 },
    { project:'BAU - Your Team Name',  us:'Code review & PR activity #2026',          tpId:326090, state:'Inception',     totAllTime:41 },
    { project:'BAU - Your Team Name',  us:'Documentation & Confluence updates #2026', tpId:325950, state:'Inception',     totAllTime:15 },
    { project:'BAU - Your Team Name',  us:'DevOps / CI-CD maintenance #2026',         tpId:326050, state:'Inception',     totAllTime:28 },
    { project:'BAU - Your Team Name',  us:'Tech debt & minor bugfixes #2026',         tpId:326060, state:'Dev/Unit test', totAllTime:19 },
