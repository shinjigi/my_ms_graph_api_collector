...
export const TS_ACTIVE: TsRow[] = [
  {
    project: "BAU - Your Team Name",
    us: "Staff company meetings #2026",
    tpId: 326100,
    state: "Inception",
    totAllTime: 47,
    hours: [0, 0, 0.5, 0, 0, 0, 0],
    git: [0, 0, 1, 0, 0, 0, 0],
    svn: [0, 0, 0, 0, 0, 0, 0],
    notes: [null, null, "Standup BAU ITA", null, null, null, null],
  },
  {
    project: "BAU - Your Team Name",
    us: "Deploy process #2026",
    tpId: 326279,
    state: "Inception",
    totAllTime: 112,
    hours: [0, 0, 0, 0, 1, 0, 0],
    git: [0, 0, 0, 1, 1, 0, 0],
    svn: [0, 0, 0, 0, 0, 0, 0],
    notes: [null, null, null, null, "Pipeline ACC fix", null, null],
  },
  {
    project: "BAU - Your Team Name",
    us: "AssetVersioning updates",
    tpId: 326215,
    state: "Dev/Unit test",
    totAllTime: 89,
    hours: [1, 0, 1, 0, 0.5, 0, 0],
    git: [1, 0, 1, 0, 0, 0, 0],
    svn: [0, 0, 0, 0, 0, 0, 0],
    notes: ["auth config", null, "asset migr.", null, "batch fix", null, null],
  },
  {
    project: "BAU - Your Team Name",
    us: "PC emails network TP #2026",
    tpId: 324913,
    state: "Inception",
    totAllTime: 203,
    hours: [1, 0, 2.5, 1, 1, 0, 0],
    git: [0, 0, 0, 0, 0, 0, 0],
    svn: [0, 0, 1, 0, 0, 0, 0],
    notes: [
      "graph auth",
  ...
  },
  {
    ...
    state: "Inception",
    totAllTime: 31,
    hours: [0, 0, 0, 1, 0.5, 0, 0],
    git: [0, 0, 0, 0, 0, 0, 0],
    svn: [0, 0, 0, 0, 0, 0, 0],
    notes: [null, null, null, "analisi scenari", null, null, null],
  },
  {
    project: "BAU - Your Team Name",
    us: "Incident #2026",
    ...
    state: "Inception",
    totAllTime: 18,
    hours: [0.5, 0, 0, 0.5, 0, 0, 0],
    git: [0, 0, 0, 0, 0, 0, 0],
    svn: [0, 0, 0, 0, 0, 0, 0],
    notes: ["hotfix prod", null, null, "triage", null, null, null],
  },
  {
    project: "Sitecore upgrade",
    us: "SC - Upgrade LocalRuntime ITA Web",
    tpId: 326183,
    state: "Testing",
    totAllTime: 55,
    hours: [0, 0, 0, 0, 0, 0, 0],
...
export const TS_PINNED: TsRow[] = [
  {
    project: "BAU - Your Team Name",
    us: "English Course - AltreAule 2025",
    tpId: 325800,
    state: "Dev/Unit test",
    totAllTime: 24,
  },
  {
    project: "BAU - Your Team Name",
    us: "Business support / Other teams #2026",
    tpId: 326110,
    state: "Inception",
    totAllTime: 67,
  },
  {
    project: "BAU - Your Team Name",
    us: "Sitecore Refactors and Updates #2026",
    tpId: 326155,
    state: "Inception",
    totAllTime: 8,
    rem: 0.2,
  ...
  {
    project: "BAU - Your Team Name",
    us: "Sprint ceremonies & planning #2026",
    tpId: 326080,
    state: "Inception",
    totAllTime: 32,
  },
  {
    project: "BAU - Your Team Name",
    us: "Code review & PR activity #2026",
    tpId: 326090,
    state: "Inception",
    totAllTime: 41,
  },
  {
    project: "BAU - Your Team Name",
    us: "Documentation & Confluence updates #2026",
    tpId: 325950,
    state: "Inception",
    totAllTime: 15,
  },
  {
    project: "BAU - Your Team Name",
    us: "DevOps / CI-CD maintenance #2026",
    tpId: 326050,
    state: "Inception",
    totAllTime: 28,
  },
  {
    project: "BAU - Your Team Name",
    us: "Tech debt & minor bugfixes #2026",
    tpId: 326060,
    state: "Dev/Unit test",
    totAllTime: 19,
  },
  {
    project: "Sitecore upgrade",
    us: "SC - ALine upgrade prep & validation",
    tpId: 326190,
    state: "Inception",
    totAllTime: 12,
  },
  {
    project: "Sitecore upgrade",
    us: "SC - SXA component refactor",
    tpId: 326195,
    state: "Dev/Unit test",
    totAllTime: 34,
  },
  {
    project: "ALine Pricing",
    us: "Pricing widget — performance fixes",
    tpId: 325900,
    state: "Testing",
    totAllTime: 21,
  },
  {
    project: "ALine Pricing",
    us: "Weekly price newsletter #2026",
    tpId: 326375,
    state: "Inception",
    totAllTime: 9,
  },
...
export const TL_EVENTS: TlEvent[] = [
  {
    type: "email-in",
    time: "08:45",
    label: "Re: Deploy process #2026 — test su ACC",
    top: 45,
    h: 18,
    emailId: 0,
    corrUs: "Deploy process #2026",
  },
  { type: "meeting", time: "09:00", label: "Standup BAU ITA", top: 60, h: 15 },
  {
    type: "email-out",
    time: "09:20",
    label: "Re: Deploy process #2026 — risolto, riprovo",
    top: 80,
    h: 18,
    emailId: 1,
    corrUs: "Deploy process #2026",
  },
  {
    type: "commit",
    time: "10:14",
    label: "[ALine] Fix SVN/Git author filtering",
    top: 134,
    h: 18,
  },
  {
    type: "email-in",
    time: "10:30",
    label: "AssetVersioning — errore su staging",
    top: 150,
    h: 18,
    emailId: 2,
    corrUs: "AssetVersioning updates",
  },
  {
    type: "email-in",
    time: "11:15",
    label: "FW: PC emails network — aggiornamento sprint",
    top: 195,
    h: 18,
    emailId: 3,
    corrUs: "PC emails network TP #2026",
  },
  {
    type: "email-in",
    time: "11:40",
    label: "Reminder: Sprint review alle 16:30",
    top: 220,
    h: 18,
  },
  {
    type: "email-out",
    time: "13:30",
    label: "AssetVersioning — fix deployato su staging",
    top: 330,
    h: 18,
    emailId: 5,
    corrUs: "AssetVersioning updates",
  },
  {
    type: "email-in",
    time: "14:00",
    label: "Re: Deploy process #2026 — ambiente ok ✓",
    top: 360,
    h: 18,
    emailId: 6,
    corrUs: "Deploy process #2026",
  },
  {
    type: "commit",
    time: "14:22",
    label: "[LocalITA] Zucchetti scraper fix",
    top: 382,
    h: 18,
  },
  {
  ...
  },
  {
    type: "svn",
    time: "16:05",
    label: "[my_ms_graph_api_collector][#324913] PC emails network - send",
    top: 485,
    h: 18,
  },
  { type: "meeting", time: "16:30", label: "Sprint Review", top: 510, h: 30 },
  {
    type: "email-in",
    time: "16:50",
    label: "Recap Sprint Review — action items",
    top: 530,
    h: 18,
    emailId: 7,
  },
  {
    type: "commit",
    time: "17:10",
    label: "[shinjigi] Analyzer — multi-backend LLM",
    top: 550,
    h: 18,
  },
];
...
export const EMAILS: Email[] = [
  ...
  {
    dir: "in",
    from: "calendar@microsoft.com",
    to: "me",
    subject: "Reminder: Sprint review alle 16:30",
    time: "11:40",
    body: "Promemoria: Sprint Review è programmato per oggi alle 16:30.\n\nPartecipanti: team BAU ITA Web + PO + SM\nDurata: 30 minuti",
  },
  {
    dir: "out",
    from: "me",
